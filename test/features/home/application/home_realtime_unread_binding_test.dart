...
void main() {
  ...
  test('does not increment unread for unknown conversation or open target',
      () async {
    final container = createContainer();
    ...
    ingress.accept(
      RealtimeEventEnvelope(
        ...
        receivedAt: DateTime(2026, 4, 20),
        seq: 1,
        payload: _messagePayload(channelId: 'unknown-channel'),
      ),
    );
    ingress.accept(
      RealtimeEventEnvelope(
    ...
    expect(unreadState.dmUnreadCount(directMessageScopeId), 0);
  });
