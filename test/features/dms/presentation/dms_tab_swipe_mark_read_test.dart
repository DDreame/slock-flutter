...
void main() {
  ...
  group('DMs tab swipe-to-mark-read', () {
    testWidgets('left swipe on unread DM triggers markRead', (tester) async {
      ...
      expect(markedReadScopeId, dmAlice.scopeId);
    });
    ...
    testWidgets('no swipe action on read DM', (tester) async {
      DirectMessageScopeId? markedReadScopeId;
      ...
      // 'dm-alice' has no unread — swipe should not trigger.
      await tester.fling(
        find.byKey(const ValueKey('dms-tab-dm-alice')),
        const Offset(-500, 0),
        1000,
    ...
    testWidgets('swipe works in dark mode', (tester) async {
      ...
      expect(markedReadScopeId, dmBob.scopeId);
      // Row persists.
      expect(
        find.byKey(const ValueKey('dms-tab-dm-bob')),
        findsOneWidget,
